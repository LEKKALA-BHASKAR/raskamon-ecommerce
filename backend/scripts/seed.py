...
CATEGORIES = [
    ...
    },
    {
        ...
        'order': 3,
        'subs': [
            {'name': 'Growth & Immunity', 'icon': '🛡️'},
            {'name': 'Nutrition', 'icon': '🥣'},
            {'name': 'Skin & Hair (Kids)', 'icon': '🧴'},
        ],
    },
    {
...
PRODUCTS = [
    # Men's Care
    {'name': 'Shilajit Gold Resin', 'category': "Men's Care", 'subcategory': 'Strength & Vitality',
    ...
    {'name': 'Ashwagandha KSM-66 Capsules', 'category': "Men's Care", 'subcategory': 'Stress & Energy',
    ...
    {'name': 'Safed Musli Power Capsules', 'category': "Men's Care", 'subcategory': 'Sexual Wellness',
    ...
    {'name': 'Bhringraj Hair Growth Oil', 'category': "Men's Care", 'subcategory': 'Hair Care for Men',
    ...
    {'name': 'Brahmi Memory Tablets', 'category': "Men's Care", 'subcategory': 'Stress & Energy',
    ...
    # Women's Care
    {'name': 'Shatavari Capsules for Women', 'category': "Women's Care", 'subcategory': 'Hormonal Balance',
    ...
    {'name': 'Kumkumadi Radiance Serum', 'category': "Women's Care", 'subcategory': 'Skin & Beauty',
    ...
    {'name': 'PCOS Care Combo (Shatavari + Triphala)', 'category': "Women's Care", 'subcategory': 'PCOS & Fertility',
    ...
    {'name': 'Calcium + Vitamin D3 (Coral Calcium)', 'category': "Women's Care", 'subcategory': 'Bone & Joint',
    ...
    {'name': 'Rose Hydrating Face Mist', 'category': "Women's Care", 'subcategory': 'Skin & Beauty',
...
HERO_SLIDES = [
    ...
    },
    {
        ...
        'accent': '#60A5FA',
        'ctas': [
            {'label': "Shop Men's Care", 'link': "/products?category=Men%27s+Care", 'style': 'primary'},
    ...
    },
    {
        ...
        'accent': '#F472B6',
        'ctas': [
            {'label': "Shop Women's Care", 'link': "/products?category=Women%27s+Care", 'style': 'primary'},
...
BANNERS = [
    ...
    {'title': 'The Kumkumadi Collection', 'subtitle': 'Ancient Kumkumadi formulations for transformative skin radiance.',
     'image': 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=1600&q=85', 'link': "/products?category=Women%27s+Care", 'position': 'home_mid', 'order': 3},
]
...
async def seed_site_kv(products):
    ...
    await kv_set('offers', [
        ...
        {'id': uid('off'), 'title': 'Flat 30% Off', 'subtitle': "Women's wellness range",
         ...
         'link': "/products?category=Women%27s+Care", 'badge': 'Sale',
