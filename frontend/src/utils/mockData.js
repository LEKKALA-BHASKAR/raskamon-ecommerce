...
export const MOCK_CATEGORIES = [
  { id: 'c1', name: "Men's Care", slug: 'mens-care', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&q=80', productCount: 48, icon: '💪', color: '#1E3A5F' },
  { id: 'c2', name: "Women's Care", slug: 'womens-care', image: 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=400&q=80', productCount: 56, icon: '🌸', color: '#831843' },
  { id: 'c3', name: "Kid's Care", slug: 'kids-care', image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&q=80', productCount: 18, icon: '🧒', color: '#0F766E' },
  { id: 'c4', name: 'Fitness & Performance', slug: 'fitness', image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=400&q=80', productCount: 39, icon: '🏋️', color: '#1A3C34' },
  { id: 'c5', name: 'Immunity & Detox', slug: 'immunity', image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&q=80', productCount: 52, icon: '🛡️', color: '#7C3AED' },
  { id: 'c6', name: 'Combos & Kits', slug: 'combos', image: 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=400&q=80', productCount: 24, icon: '🎁', color: '#C8A96E' },
  { id: 'c7', name: 'Others', slug: 'others', image: '', productCount: 0, icon: '🔖', color: '#6B7280' },
];
...
export const MOCK_ADMIN_STATS = {
  ...
  todayOrders: 47,
  todayAOV: 2013,
  yesterdayRevenue: 82400,
  yesterdayOrders: 41,
  yesterdayAOV: 2010,
  thisMonthRevenue: 872650,
  thisMonthOrders: 609,
  thisMonthAOV: 1433,
  lastMonthRevenue: 748900,
  lastMonthOrders: 523,
  paymentMethods: [
    { _id: 'razorpay', count: 312, revenue: 2846200 },
    { _id: 'cod', count: 189, revenue: 1324800 },
    { _id: 'upi', count: 78, revenue: 498200 },
    { _id: 'wallet', count: 30, revenue: 203450 },
  ],
  cancelRate: 4.2,
  hourlySales: [
    { _id: 0, orders: 1, revenue: 1999 }, { _id: 1, orders: 0, revenue: 0 },
    { _id: 2, orders: 0, revenue: 0 }, { _id: 3, orders: 0, revenue: 0 },
    { _id: 4, orders: 0, revenue: 0 }, { _id: 5, orders: 1, revenue: 899 },
    { _id: 6, orders: 2, revenue: 3498 }, { _id: 7, orders: 3, revenue: 5197 },
    { _id: 8, orders: 5, revenue: 8245 }, { _id: 9, orders: 6, revenue: 11894 },
    { _id: 10, orders: 7, revenue: 14392 }, { _id: 11, orders: 5, revenue: 9345 },
    { _id: 12, orders: 4, revenue: 7298 }, { _id: 13, orders: 3, revenue: 5199 },
    { _id: 14, orders: 3, revenue: 4898 }, { _id: 15, orders: 2, revenue: 3598 },
    { _id: 16, orders: 2, revenue: 3998 }, { _id: 17, orders: 1, revenue: 1999 },
    { _id: 18, orders: 1, revenue: 2199 }, { _id: 19, orders: 1, revenue: 1449 },
  ],
  topProducts: [
  ...
  topCustomers: [
    { name: 'Ananya Gupta', email: 'ananya@gmail.com', orders: 12, totalSpent: 22400 },
    { name: 'HealthBridge Distributors', email: 'buy@healthbridge.in', orders: 48, totalSpent: 2847600 },
    { name: 'Priya Sharma', email: 'priya@gmail.com', orders: 8, totalSpent: 14296 },
    { name: 'WellnessFirst Pharma', email: 'procurement@wellnessfirst.com', orders: 24, totalSpent: 1234500 },
    { name: 'Rohit Patel', email: 'rohit@gmail.com', orders: 3, totalSpent: 3597 },
  ],
  recentOrders: [
    { id: 'ord1', invoiceId: 'INV-20260502-001', userName: 'Priya Sharma', totalAmount: 2998, orderStatus: 'delivered', paymentMethod: 'razorpay', createdAt: '2026-05-02T14:30:00Z', items: [{ name: 'Kumkumadi Serum' }, { name: 'Triphala' }] },
    { id: 'ord2', invoiceId: 'INV-20260502-002', userName: 'Rohit Patel', totalAmount: 1199, orderStatus: 'shipped', paymentMethod: 'upi', createdAt: '2026-05-02T11:15:00Z', items: [{ name: 'Ashwagandha KSM-66' }] },
    { id: 'ord3', invoiceId: 'INV-20260501-003', userName: 'Ananya Gupta', totalAmount: 5499, orderStatus: 'confirmed', paymentMethod: 'razorpay', createdAt: '2026-05-01T18:22:00Z', items: [{ name: 'Shilajit Gold' }, { name: 'Brahmi Tablets' }] },
    { id: 'ord4', invoiceId: 'INV-20260501-004', userName: 'Vikram Singh', totalAmount: 899, orderStatus: 'placed', paymentMethod: 'cod', createdAt: '2026-05-01T16:44:00Z', items: [{ name: 'Chyawanprash' }] },
    { id: 'ord5', invoiceId: 'INV-20260430-005', userName: 'Meera Iyer', totalAmount: 3297, orderStatus: 'delivered', paymentMethod: 'razorpay', createdAt: '2026-04-30T09:00:00Z', items: [{ name: 'Hair Kit' }, { name: 'Moringa' }] },
    { id: 'ord6', invoiceId: 'INV-20260430-006', userName: 'HealthBridge Distributors', totalAmount: 89400, orderStatus: 'delivered', paymentMethod: 'razorpay', createdAt: '2026-04-28T09:00:00Z', items: [{ name: 'Ashwagandha B2B ×100' }] },
    { id: 'ord7', invoiceId: 'INV-20260429-007', userName: 'Sneha Reddy', totalAmount: 1998, orderStatus: 'shipped', paymentMethod: 'upi', createdAt: '2026-04-29T12:30:00Z', items: [{ name: 'Shatavari' }, { name: 'Guduchi' }] },
    { id: 'ord8', invoiceId: 'INV-20260429-008', userName: 'Arjun Nair', totalAmount: 4498, orderStatus: 'confirmed', paymentMethod: 'cod', createdAt: '2026-04-29T10:15:00Z', items: [{ name: 'Skin Kit' }, { name: 'Serum' }] },
  ],
  ordersByStatus: [
    ...
    { _id: 'placed', count: 45 },
    { _id: 'out_for_delivery', count: 34 },
    { _id: 'cancelled', count: 23 },
  ],
  categoryRevenue: [
    { name: "Men's Care", value: 1876400 },
    { name: "Women's Care", value: 1432800 },
    { name: 'Immunity & Detox', value: 678900 },
    { name: 'Fitness & Performance', value: 452300 },
    { name: 'Combos & Kits', value: 231250 },
  ],
  monthlyRevenue: [
    { _id: '2025-11', revenue: 312400, orders: 218 },
    { _id: '2025-12', revenue: 489200, orders: 341 },
    { _id: '2026-01', revenue: 521800, orders: 364 },
    { _id: '2026-02', revenue: 634700, orders: 443 },
    { _id: '2026-03', revenue: 748900, orders: 523 },
    { _id: '2026-04', revenue: 872650, orders: 609 },
  ],
  revenueTrend: [],
};
